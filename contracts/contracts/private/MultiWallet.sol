...
contract MultiWallet is ReentrancyGuard {
    ...
    address wallet3_7 = 0x971bCD2823ab07b39eA765Bd5863A4e63e0c7205; // Alexander
    ...
    address wallet6_10 = 0xbF588e41A13314b84C22b3e2215f56DefE09C638; // disgner department 10% tmp Alexander
    address wallet7_8  = 0xFF996042E1f9e11c9658e5bEdce2363F853490F1; //  NN change wallet
    ...
    function divide() external nonReentrant {
        ...
        wallet10_206.transfer(totalBalance - w7 * 4 - w2 - w10 - w8 - w05);
   }
