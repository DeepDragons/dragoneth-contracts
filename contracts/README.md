...
8. DragonStat		*func*	adminAddRole(address DragonsFightPlace "", "FightContract" string )
9. DragonStat		*func*	adminAddRole(address DragonsFightPlace "", "ActionContract" string)
10. DragonETH		*func*	adminAddRole(address DragonsFightPlace "", "ActionContract" string)
11. Mutagen		*func*	adminAddRole(address DragonsFightPlace "", "MintAgent" string)
